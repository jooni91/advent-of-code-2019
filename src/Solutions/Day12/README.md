...
The difficulty shift is dramatic for part 1 and 2. The first part was did not require a lot of math, after creating a moon object which contained all the values for one instance of a moon it was just looping 1000 times and updating the values for of each moon. But for the second part I needed a little help again. After getting the idea how to solve part 2 (still don't fully understand it thou), I was able to come up with a pretty cool async solution. 
