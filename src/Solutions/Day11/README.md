# Day 11: Space Police
This day cheared me up again after almost getting depressed, because of the previous day. I built my own little painting robot, which made use of the Intcode Computer that we've build over the days to run a painting program. The robot first started on a black background to count how many unique fields it was painting. After that it ran on a white background and we got a nice bitmap again that we could save as an image afterwards. The robot drew a code, which was the answer to part 2. I've added [the image to the bottom](#images) of this README again.
...
Your puzzle answer was `RAPRCBPH`.

## Images

#### Automatically generated image

![Automatically generated](../../../images/AoC2019_Day11_generated.png)